...
class SocialGraph:
    def __init__(self):
        ...
        # is an adjacent list from representation of a graph graph.py
        self.friendships = {} # contain our connections
    ...
    def populate_graph(self, num_users, avg_friendships):
        ...
        # [(1,2), (1,3), (1,4), (1,5), ..etc (2,3), (2,4), (2,5)]
        friendship_combinations = [] #[[1,2] | [1,3]| ]
        # O(n^2)
        for user in range(1, self.last_id + 1):# user: 1
        ...
        #  shuffle the list, randomly choose people to make friends
        self.fisher_yates_shuffle(friendship_combinations)

        # then grab the first N elements from the list. 
        total_friendships = num_users * avg_friendships #20 = 10 * 2
    ...
    ## Think of another way for two random way to make people friends
    ...
    def populate_graph_linear(self, num_users, avg_friendships):
        ...
        friends_made = 0
    # until we've made the total friendship we want
        while friends_made < total_friendships:
...
if __name__ == '__main__':
    ...
    end_time = time.time()
    print('linear end time', end_time - start_time)
    ...
    print("percentage of users in social network: ", len(connections) / 100 * 100)
